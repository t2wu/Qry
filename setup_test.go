...
type Cat struct {
	...
	TestModelID *datatype.UUID `gorm:"type:uuid;index;" json:"_"`
}
...
type Dog struct {
	...
	TestModelID *datatype.UUID `gorm:"type:uuid;index;not null;" json:"_"`
}
...
type DogToy struct {
	...
	DogID *datatype.UUID `gorm:"type:uuid;index;not null;" json:"_"`
}
...
type UnNested struct {
	...
	TestModelID *datatype.UUID `gorm:"type:uuid;index;not null;" json:"-"`
}
...
type UnNestedInner struct {
	...
	UnNestedID *datatype.UUID `gorm:"type:uuid;index;not null;" json:"-"`
}
...
func TestMain(m *testing.M) {
	...
	// log.Println("datatype.NewUUIDFromStringNoErr(dogtoyuuid1):", datatype.NewUUIDFromStringNoErr(dogtoyuuid1))
	// log.Println("datatype.NewUUIDFromStringNoErr(doguuid2):", datatype.NewUUIDFromStringNoErr(doguuid2))
	dogToy1 := DogToy{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(dogtoyuuid1)},
		ToyName:   "DogToySameName",
		DogID:     datatype.NewUUIDFromStringNoErr(doguuid2),
	}
	dogToy2 := DogToy{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(dogtoyuuid2)},
		ToyName:   "DogToySameName",
		DogID:     datatype.NewUUIDFromStringNoErr(doguuid4),
	}

	dog0 := Dog{
		BaseModel:   mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(doguuid0)},
		Name:        "Doggie0",
		Color:       "purple",
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid1),
	}
	dog1 := Dog{
	...
	dog3 := Dog{
		BaseModel:   mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(doguuid3)},
		Name:        "Doggie3",
		Color:       "blue",
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid1),
	}
	dog4 := Dog{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(doguuid4)},
		Name:      "Doggie4",
		Color:     "green",
		// DogToys:     []DogToy{dogToy2},
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid5),
	}
	...
	tm2 := TestModel{BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(uuid2)}, Name: "second", Age: 3}
	tm3 := TestModel{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(uuid3)},
		Name:      "same", Age: 3,
		Dogs: []Dog{dog1, dog2},
	}
	tm4 := TestModel{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(uuid4)},
		Name:      "same", Age: 4, Dogs: []Dog{dog3},
	}
	tm5 := TestModel{
		BaseModel: mdl.BaseModel{ID: datatype.NewUUIDFromStringNoErr(uuid5)},
	...
	unnested1 := UnNested{
		BaseModel: mdl.BaseModel{
			ID: datatype.NewUUIDFromStringNoErr(unnesteduuid1),
		},
		UnNestedInner: UnNestedInner{
			BaseModel: mdl.BaseModel{
				ID: datatype.NewUUIDFromStringNoErr(unnesteduuid1inner),
			},
			Name:       "UnNestedInnerSameNameWith1&2",
			UnNestedID: datatype.NewUUIDFromStringNoErr(unnesteduuid1),
		},
		Name:        "unnested1",
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid1),
	}
	...
	unnested2 := UnNested{
		BaseModel: mdl.BaseModel{
			ID: datatype.NewUUIDFromStringNoErr(unnesteduuid2),
		},
		UnNestedInner: UnNestedInner{
			BaseModel: mdl.BaseModel{
				ID: datatype.NewUUIDFromStringNoErr(unnesteduuid2inner),
			},
			Name:       "UnNestedInnerSameNameWith1&2",
			UnNestedID: datatype.NewUUIDFromStringNoErr(unnesteduuid2),
		},
		Name:        "unnested2",
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid2),
	}
	unnesteduuid3 := "e2bf6b2a-127c-491b-b6a2-49d88d217425"
	unnested3 := UnNested{
		BaseModel: mdl.BaseModel{
			ID: datatype.NewUUIDFromStringNoErr(unnesteduuid3),
		},
		Name:        "unnested3",
		TestModelID: datatype.NewUUIDFromStringNoErr(uuid2),
	}
